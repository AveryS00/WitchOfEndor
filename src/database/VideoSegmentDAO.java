...
public class VideoSegmentDAO {
	 ...
	 */
	public boolean addVideoSegment (VideoSegment vs) throws SQLException {
		try {
			if (isInDatabase(vs)) {
				return false;
			}
	 ...
	 */
	public boolean updateVideoSegment (VideoSegment vs) throws SQLException {
		try {
			if (!isInDatabase(vs)) {
				return false;
			}
	 ...
	 */
	public boolean deleteVideoSegment (String location) throws SQLException {
		try {
	 ...
	 */
	public List<VideoSegment> listAllVideoSegments () throws SQLException {
